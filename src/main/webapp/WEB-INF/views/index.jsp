                    ...
                    <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <img class="d-block img-fluid" src="resources/img/organicproducts1.jpg" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block img-fluid" src="resources/img/organicproducts2.jpg" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block img-fluid" src="resources/img/organicproducts3.jpg" alt="Third slide">
                            </div>
                            <div class="carousel-item">
